  ...
  getBaseRedirect = () => {
    ...
    if (redirect) {
      ...
      const authorizedPath = Object.keys(routerData).find(
        item => check(routerData[item].authority, item) && item !== '/admin'
      );
            ...
            <Content className={styles.layoutContent}>
              <Switch>
                ...
                {getRoutes(match.path, routerData).map(item => (
                  <AuthorizedRoute
                    ...
                    redirectPath="/admin/exception/403"
                  />
                ))}
                <Redirect exact from="/admin" to={bashRedirect} />
              ...
              <Footer style={{ padding: 0 }}>
                <GlobalFooter
                  ...
                  copyright={<Fragment>Copyright © 2018 轻易技术体验出品</Fragment>}
                />
              </Footer>
            </Content>
          </Layout>
